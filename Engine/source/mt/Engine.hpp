...
namespace mt
{
	...
	private:
		...
		renderer::DirectXRenderer		_direct_x_renderer;
		...
		time::Duration          _time_since_stat_update = 0ns;
	...
	public:	
		...
		static	time::TimeManager&			GetTimeManager()			{ return GetEngine()._time_manager; };
		static	renderer::DirectXRenderer&	GetRenderer()				{ return GetEngine()._direct_x_renderer; };
