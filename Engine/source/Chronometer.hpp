...
private:
	...
	std::function<void(Chronometer&, const TimePoint&, const TimePoint&, const Duration&)> _current_tick_function = &Chronometer::Inactive;
	...
	void Inactive(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
		_is_running = false;
	}

	void Started(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
	...
	void Active(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
		_duration_since_started = current_tick_time - _start_time;
	...
	void Paused(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
		_duration_since_started = current_tick_time - _start_time;
	...
	void FullPause(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
		_duration_since_started = current_tick_time - _start_time;
	...
	void Continued(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
		_duration_since_started = current_tick_time - _start_time;
	...
	void Stopped(const TimePoint& current_tick_time, const TimePoint& previous_tick_time, const Duration& delta_time)
	{
...
public:
	...
	Chronometer(const char* timer_name, bool can_pause = true)
		...
		, _average_active_duration(0ns)
		, _average_paused_duration(0ns)
		, _average_total_duration(0ns)
		, _name(timer_name)
	...
	Chronometer(Chronometer&& other)
		...
		, _paused_samples			(std::move(other._active_samples))
		, _total_samples			(std::move(other._active_samples))
